...
load("//closure/templates:closure_java_template_library.bzl", "closure_java_template_library", "closure_template_java_library")
load("//closure/templates:closure_js_template_library.bzl", "closure_js_template_library", "closure_template_js_library")
