...
--- | --- | --- | ---
[closure_js_library](#closure_js_library) | [closure_js_template_library](#closure_js_template_library) | [closure_css_library](#closure_css_library) | [closure_js_proto_library](#closure_js_proto_library)
[closure_js_binary](#closure_js_binary) | [closure_java_template_library](#closure_java_template_library) | [closure_css_binary](#closure_css_binary) | [phantomjs_test](#phantomjs_test)
[closure_js_deps](#closure_js_deps) | [closure_py_template_library](#closure_py_template_library) | |
...
- **deps:** (List of [labels][labels]; optional) Direct [dependency][dependency]
  list. These can point to `closure_js_library`, `closure_js_template_library`,
...
- **deps:** (List of [labels][labels]; required) Direct dependency list. This
  ...
  point to `closure_js_library` and `closure_js_template_library` rules.
...
- **deps:** (List of [labels][labels]; required) List of `closure_js_library`
  and `closure_js_template_library` targets which define all JavaScript sources
  in your application.
...
- **deps:** (List of [labels][labels]; optional) List of `closure_js_library`
  and `closure_js_template_library` targets which define symbols referenced by
  the template.
