...
java_import_external(
    ...
    jar_urls = [
        "http://mirror.bazel.build/repo1.maven.org/maven2/com/google/guava/guava-testlib/20.0/guava-testlib-20.0.jar",
...
java_import_external(
    ...
    jar_urls = [
        "http://mirror.bazel.build/repo1.maven.org/maven2/com/google/jimfs/jimfs/1.1/jimfs-1.1.jar",
...
java_import_external(
    ...
    jar_urls = [
        "http://mirror.bazel.build/repo1.maven.org/maven2/junit/junit/4.11/junit-4.11.jar",
...
java_import_external(
    ...
    jar_urls = [
        "http://mirror.bazel.build/repo1.maven.org/maven2/org/mockito/mockito-all/1.10.19/mockito-all-1.10.19.jar",
